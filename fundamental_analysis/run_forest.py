...
class Display:
    ...
    def features_histograms(self, ticker=None):
        ...
        plt.title(f'{ticker}')
        plt.savefig(f'{ticker}_features_histograms.png', bbox_inches='tight')
        #plt.show()
    ...
    def plot_corr_heatmap(self, ticker=None):
        ...
        plt.savefig(f'{ticker}_plot_corr_heatmap.png', bbox_inches='tight')
        #plt.show()
    ...
    def plot_corr_heatmap_fs(self, ticker=None):
        ...
        plt.savefig(f'{ticker}_plot_corr_heatmap_fs.png', bbox_inches='tight')
        #plt.show()
...
class XGB_training:
    ...
    def predict(self, ticker=None):
        ...
        for m in self._metric:
            ...
            ax.legend()
            ax.set_ylabel(m)
            plt.savefig(f'{ticker}_training.png', bbox_inches='tight')
        #plt.show()
        ...
        plt.savefig(f'{ticker}_plot_importance.png', bbox_inches='tight')
        #plt.show()
